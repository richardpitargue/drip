...
if start is not None:
    ...
    while info is not None:
        result = get('http://159.203.253.4:3001/data/{id}/waterdeficit/{d}-{m}-{y}'.format(id=farm['location']['stationId'], d=start_update.day, m=start_update.month, y=start_update.year))
        data = result.json()
